...
fn main() {
    ...
    measure_running_time(
        Path::new(
            "data/Experiments/experiment_matrices/running_time/brute_force_growth_with_e_tau.csv",
        ),
    ...
    measure_running_time(
        Path::new(
            "data/Experiments/experiment_matrices/running_time/brute_force_growth_with_graph.csv",
        ),
        simple_brute_force_for_ntd_set,
        &"brute_force".to_string(),
    );
    ...
    measure_running_time(
        Path::new(
            "data/Experiments/experiment_matrices/running_time/modified_dp_growth_with_e_tau.csv",
        ),
        modified_dp,
    ...
    measure_running_time(
        Path::new(
            "data/Experiments/experiment_matrices/running_time/modified_dp_growth_with_graph.csv",
        ),
        modified_dp,
        &"modified_dp".to_string(),
    );
    ...
    measure_running_time(
        Path::new("data/Experiments/experiment_matrices/running_time/mixed_combinations.csv"),
        diaz_serna_thilikos_for_ntd_set,
        &"diaz_serna_thilikos".to_string(),
    );
