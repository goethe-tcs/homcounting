...
pub mod tree_decomposition_handler {
        ...
        P: AsRef<Path>,
    {
        ...
        if let Ok(lines) = read_lines(filename) {
            ...
            for line in lines {
                ...
                match type_arg {
                    ...
                    Some("n") => {
                         ...
                         */
                        let node_index =
                            (args.next().unwrap().parse::<u32>().unwrap() - 1) as TreeNode;
                        ...
                        let node_data = match node_type {
                            ...
                            _ => {
                                panic!("cannot identify this node type");
            ...
            Some(NiceTreeDecomposition::new(
                tree_structure,
                nodes_data,
                number_of_vertices,
                max_bag_size - 1,
...
pub mod graph_handler {
    ...
    pub fn import_metis<P>(
        filename: P,
    ) -> Option<petgraph::matrix_graph::MatrixGraph<(), (), Undirected>>
    where
        P: AsRef<Path>,
    {
        ...
        P: AsRef<Path>,
    {
        ...
        let mut number_of_vertices: usize;
        ...
        if let Ok(lines) = read_lines(filename) {
            ...
            for line in lines {
                ...
                match type_arg {
                    ...
                    Some("p") => {
                        let _problem_descriptor = args.next();
                    ...
                    Some(_) => {
                        ...
                        if !graph.has_edge(Vertex::new(first_vertex), Vertex::new(second_vertex)) {
                            graph.add_edge(
                                Vertex::new(first_vertex),
                                Vertex::new(second_vertex),
                                (),
                            );
                        }
                    }
